...
const CaptainLogin = () => {
    ...
    return(
        <div className='p-7 h-screen flex flex-col justify-between'>
            ...
            <div>
                <Link to={'/login'} className='bg-[#d5622d] flex item-center justify-center text-white font-semibold mb-3 rounded px-4 py-2 w-full text-lg placeholder:text-base'>
